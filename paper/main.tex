...
this rarely occurs. Understanding this phenomenon requires disentangling two distinct
questions: \emph{what does the loss landscape look like} (its static geometry), and
\emph{how does an optimizer move through it} (the dynamics). This paper addresses
the first question precisely and connects it to the second empirically.
...
of optimization difficulty. This adds to a growing body of evidence that the success
