...
\addplot[draw=none, fill=white] {2*(1-2*x)/(1-x-x^2)} \closedcycle;
\addplot[draw=none, fill=red, fill opacity=0.1] {2*(1-2*x)/(1-x-x^2)} \closedcycle;

\addplot[thick, black] {2*(1-2*x)/(1-x-x^2)};
\addplot[thick, black, dashed] {4/(2+3*x)};
