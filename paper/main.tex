...
% Shaded subcritical region (below curve) - red
\addplot[red, fill=red, fill opacity=0.08, draw=none, domain=0.01:3, samples=200]
  {4/(2 + 3*x)} \closedcycle;
% Shaded supercritical region (above curve) - blue
\addplot[blue, fill=blue, fill opacity=0.08, draw=none, domain=0.01:3, samples=200]
  {4/(2 + 3*x)} |- (axis cs:3,2) |- (axis cs:0.01,2) -- cycle;
% The critical curve
\addplot[black, very thick, smooth, domain=0.01:3, samples=200]
  {4/(2 + 3*x)};
\addlegendentry{$\gamma^\star(\delta) = \frac{4}{2 + 3\delta}$}
% gamma = 1 interpolation line
\addplot[dashed, gray!70, domain=0:3] {1};
\addlegendentry{$\gamma = 1$ (interpolation threshold)}
% Annotations centered in their regions
\node[blue, font=\footnotesize] at (axis cs:1.5,1.4) {All minima global};
\node[red, font=\footnotesize] at (axis cs:1.8,0.2) {Spurious minima exist};
\end{axis}
\end{tikzpicture}%
}
