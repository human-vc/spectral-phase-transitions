...
\begin{itemize}
  ...
  lower than the asymptotic theory predicts. However, a ``hero run'' at $n = 1500$ with
  $\delta = 0.3$ (Gaussian teacher-student data, 20 seeds per $\gamma$, 10 values of
  $\gamma/\gamma_\star$ from $0.3$ to $2.0$) achieved $100\%$ global convergence at
  every tested point---including at $\gamma = 0.3\,\gamma_\star$, deep in the subcritical
  regime. This demonstrates that the landscape--dynamics gap does not close at
  moderate~$n$, ruling out finite-size effects as the primary explanation.
