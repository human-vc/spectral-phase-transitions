...
A deterministic equivalent for the gated Hessian resolvent, established via the
anisotropic local law framework of Knowles and Yin, shows that the spectral statistics
at bounded-loss critical points are independent of the weight-data dependence structure,
making all results unconditional.
\end{abstract}
