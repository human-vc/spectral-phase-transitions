...
\node[gray, anchor=south west, font=\footnotesize] at (axis cs:0.35, 0.5) {Slope $1$};

\draw[black!50, thick, <->] (axis cs:1e-3, 5e-3) -- (axis cs:5e-3, 5e-3);
\node[black!50, anchor=south, font=\scriptsize] at (axis cs:2.2e-3, 5.5e-3) {TW window};
